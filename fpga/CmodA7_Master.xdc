...
set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports { trigger_source }]; #IO_L1N_T0_34 Sch=pio[30]
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports { trigger_out }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
