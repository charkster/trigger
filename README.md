...
These designs were put into a Digilent CMOD A7 fpga board, and I have 2 versions: one with a 12MHz clock and another with a 100MHz clock. The stage1_count for the pattern_generator and trigger blocks can be used to adjust the clock to be a multiple of base 10.
